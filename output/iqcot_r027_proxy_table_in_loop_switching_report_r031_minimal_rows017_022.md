...
- Plan mode: `r031_minimal_rows017_022`
- Result CSV: `E:/Desktop/codex/output/iqcot_r027_proxy_table_in_loop_results_r031_minimal_rows017_022.csv`
- Policy CSV: `E:/Desktop/codex/output/iqcot_r027_proxy_table_in_loop_policy_eval_r031_minimal_rows017_022.csv`
...
Executed rows: `6`. Treat small `maxCases` runs as interface smoke tests, not complete R027 evidence.

## Policy summary

| Policy | role | online inputs | mean regret | max regret | mean objective | mean undershoot mV | mean settle us |
|---|---|---:|---:|---:|---:|---:|---:|
| `r031_minimal_candidate` | `candidate` | 1 | 0.164 | 0.669 | 2.795 | 0.992 | 9.192 |
