...
第三，参考斜率扫描已经从 `0,5,10,20,40 us` 扩展到 `20,30,40,50,60,80,100,120 us`，但仍是离散网格。`80 us`、`60 us` 或恢复时间惩罚下的 `30 us` 都只能解释为当前目标函数和当前网格下的最佳折中点，不是全局最优。
...
| 主要图 | `E:/Desktop/codex/output/figures/fig21_ai_delay_event_surrogate.svg`; `fig22_dynamic_load_validation.png`; `fig23_dynamic_ref_slew_sweep.png`; `fig23_dynamic_ref_slew_dense_sweep.png`; `fig24_ref_slew_settle_penalty.png` |
