function modelFile = e010_a5_build_baseline_audit_model(variant)
%E010_A5_BUILD_BASELINE_AUDIT_MODEL Build A5-C0/C4 audit models.
% The ideal IQCOT baseline is copied first. All edits are logging-only for
% A5-C0, and previous A4 projected behavior plus logging for A5-C4.
...
if variant == "A5-C0"
    modelName = "E010A5_C0_baseline_40A_1A_" + dateTag;
elseif variant == "A5-C4"
    modelName = "E010A5_C4_previous_A4_40A_1A_" + dateTag;
else
...
if variant == "A5-C4"
    addScalarConstantLog(modelName, "a_O_state", "4", [4080 1535 4210 1565]);
else
    addScalarConstantLog(modelName, "a_O_state", "0", [4080 1535 4210 1565]);
end
end

function addAuditStateConstants(modelName, variant)
unusedVariant = variant; %#ok<NASGU>
addScalarConstantLog(modelName, "area_hold_state", "0", [4080 1580 4210 1610]);
addScalarConstantLog(modelName, "reentry_state", "0", [4080 1625 4210 1655]);
...
addScalarConstantLog(modelName, "area_hold_count", "0", [4080 1760 4210 1790]);
addScalarConstantLog(modelName, "area_reset_count", "0", [4080 1805 4210 1835]);
addScalarConstantLog(modelName, "area_bleed_count", "0", [4080 1850 4210 1880]);
