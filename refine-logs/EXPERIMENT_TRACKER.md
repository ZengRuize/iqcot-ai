...
| R015 | M6 | 整合论文与证据矩阵 | PIS-IEK hybrid + Simulink + AI-delay surrogate | four-phase only | paper draft, derivation package, claim-evidence matrix | MUST | DONE | 已生成 `iqcot_integrated_research_paper.md`、`iqcot_pis_iek_derivation_package.md`、`iqcot_claims_evidence_matrix.md`；明确禁止过度声称 AI、全局最优和第一峰精确预测 |
