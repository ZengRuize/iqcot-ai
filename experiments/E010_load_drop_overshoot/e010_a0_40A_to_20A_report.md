...
A0 measures the original ideal IQCOT response to an external `40A -> 20A` load-current disturbance. No AI/table action is applied, and the load current is not an AI command.

## Paths

- Derived model: `E:/Desktop/codex/models/derived/E010_A0_load_drop_observable_from_ideal_iqcot_20260628.slx`
- Metrics CSV: `E:/Desktop/codex/experiments/E010_load_drop_overshoot/e010_a0_40A_to_20A_metrics.csv`
- Wave sample CSV: `E:/Desktop/codex/experiments/E010_load_drop_overshoot/e010_a0_40A_to_20A_wave_sample.csv`
