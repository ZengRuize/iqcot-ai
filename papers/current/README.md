...
```text
papers/current/iqcot_ai_supervisor_draft.md
```
...
experiments/E040_active_phase_add_shed/S0_shed_phase_minimal/e040_s0_metrics.csv
...
```text
Simulink-only ideal derived-model evidence.
